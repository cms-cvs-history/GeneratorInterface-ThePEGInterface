...
# with command line options: Configuration/GenProduction/testThePEGProducer -s GEN:ProductionFilterSequence --datatier GEN -n 100 --eventcontent RAWSIM --conditions FrontierConditions_GlobalTag,IDEAL_31X::All --no_exec --mc --customise=Configuration/GenProduction/custom
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/GeneratorInterface/ThePEGInterface/test/testThePEGProducer_GEN_IDEAL.py,v $')
)
