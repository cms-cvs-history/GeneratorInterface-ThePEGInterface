...
# with command line options: GeneratorInterface/ThePEGInterface/testThePEGGeneratorFilter.py -s GEN:ProducerSourceSequence --datatier GEN -n 100 --eventcontent RAWSIM --conditions FrontierConditions_GlobalTag,IDEAL_30X::All --no_exec --customise=Configuration/GenProduction/generatorProducer.py
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('testThePEGGeneratorFilter_py_GEN.root'),
